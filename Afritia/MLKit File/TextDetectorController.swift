...
class TextDetectorController: UIViewController,AVCaptureVideoDataOutputSampleBufferDelegate {
   ...
   // var textString  = [VisionText]()
    ...
    override func viewDidLoad() {
     ...
     //   textDetector =  Vision.vision().cloudTextRecognizer()
...
extension TextDetectorController: UITableViewDelegate, UITableViewDataSource {
