...
class ImageDetectorController: UIViewController,AVCaptureVideoDataOutputSampleBufferDelegate {
 ...
 //   var textDetector: VisionImageLabeler!
    var frameCount = 0
   // lazy var vision = Vision.vision()
    static let labelConfidenceThreshold: Float = 0.75
    var delegate: SuggestionDataHandlerDelegate!
    @IBOutlet var tableView: UITableView!
  //  var textString  = [VisionImageLabel]()
...
//    private func flattenVisionText(visionText: [VisionImageLabel]?) -> String {
//        var text = ""
...
//            }
            /*
             textDetector.detectInImage(in: viImage) { (visionText, error) in
                  completion(self.flattenVisionText(visionText: visionText), image)
             }*/
        }
    }
...
extension ImageDetectorController : UITableViewDelegate, UITableViewDataSource {
