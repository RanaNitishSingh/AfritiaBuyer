...
class HotdealsTableViewCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        super.awakeFromNib()
        hotdealLabel.text = GlobalData.sharedInstance.language(key: "hotdeals")
        ...
        hotdelalCollectionView.backgroundColor = UIColor.white
    }
...
extension HotdealsTableViewCell: UICollectionViewDelegate, UICollectionViewDataSource , UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return hotdealCollectionModel.count == 1 ? hotdealCollectionModel.count : (hotdealCollectionModel.count + 1)
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if indexPath.row < hotdealCollectionModel.count{
            ...
            if hotdealCollectionModel[indexPath.row].isFreeShipping == "Yes"{
                cell.lblShipping.text = "freeshipping".localized
            }else{
                
                cell.lblShipping.text = "shippingword".localized + ": \(hotdealCollectionModel[indexPath.row].shippingPrize ?? "0")"
            }
