...
public enum UPCarouselFlowLayoutOffsetMode {
    case leading
    case center
}
...
open class UPCarouselFlowLayout: UICollectionViewFlowLayout {
    ...
    open var offsetMode = UPCarouselFlowLayoutOffsetMode.center
    ...
    fileprivate func updateLayout() {
        ...
        var yInset:CGFloat = 0.0//(collectionSize.height - self.itemSize.height) / 2
        var xInset:CGFloat = 0.0 //(collectionSize.width - self.itemSize.width) / 2
        
        switch self.offsetMode {
        case .leading:
            yInset = 0.0
            xInset  = 0.0
        case .center:
            yInset = (collectionSize.height - self.itemSize.height) / 2
