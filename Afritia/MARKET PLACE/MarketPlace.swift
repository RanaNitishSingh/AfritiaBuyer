...
class MarketPlace: UIViewController {
    ...
    @IBOutlet weak var view1ViewAll: UIButton!
    ...
    func callingHttppApi(){
        ...
        APIServiceManager.shared.callingHttpRequest(params:requstParams, apiname:"mobikulmphttp/marketplace/landingPageData", currentView: self){success,responseObject in
            if success == 1{
    ...
    @IBAction func View1OpenYourshopClick(_ sender: Any) {
        ...
        if customerId == nil{
            let vc = AppStoryboard.Main.instance.instantiateViewController(withIdentifier: "CustomerLogin") as! CustomerLogin
            self.navigationController?.pushViewController(vc, animated: true)
        }else{
            if DEFAULTS.object(forKey: "isSeller") as! String == "t" && DEFAULTS.object(forKey: "isPending") as! String == "f"  {
                
                let aleartVC = UIAlertController(title: "message".localized, message: "Youarealreadysellingwithus".localized, preferredStyle: .alert)
                let okBtn = UIAlertAction(title: "ok".localized, style: .cancel, handler: nil)
                aleartVC.addAction(okBtn)
    ...
    @IBAction func view1ViewAll(_ sender: Any) {
        let vc = AppStoryboard.Marketplace.instance.instantiateViewController(withIdentifier: "SellerListController") as! SellerListController
        self.navigationController?.pushViewController(vc, animated: true)
    }
    ...
    func showLatout1View() {
        ...
        for i in 0..<self.mainCollection["layout1"]["sellersData"].count{
            ...
            sellerName.textColor = UIColor.appLightGrey
            ...
            sellerProductCount.textColor = UIColor.appLightGrey
            ...
            viewallProduct.textColor = UIColor.button
            viewallProduct.font = UIFont(name: BOLDFONT, size: 15.0)
            viewallProduct.text = "viewall".localized
            ...
            for j in 0..<dict["products"].count{
                ...
                productName.textColor = UIColor.appLightGrey
        ...
        view1ViewAll.setTitle("viewall".localized, for: .normal)
        view1ViewAll.backgroundColor = UIColor.button
        view1ViewAll.layer.cornerRadius = 4.0
    ...
    @objc func viewAllProduct(_ recognizer: UITapGestureRecognizer) {
        ...
        vc.categoryName = dict["shopTitle"].stringValue
        vc.categoryType = "marketplace"
        vc.sellerId = dict["sellerId"].stringValue
        self.navigationController?.pushViewController(vc, animated: true)
    }
...
extension MarketPlace : WKNavigationDelegate {
