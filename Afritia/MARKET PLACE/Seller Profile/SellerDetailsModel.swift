...
class SellerRecentProduct{
    ...
    init(data: JSON) {
        print("Data Seller Info \(data)")
        productImage = data["thumbNail"].stringValue
        descriptionData = data["shortDescription"].stringValue.html2String
        id = data["entityId"].stringValue
        ...
        isInRange = data["isInRange"].boolValue
        formatedPrice = data["formatedPrice"].stringValue
        specialPrice = data["finalPrice"].doubleValue
        normalprice = data["price"].doubleValue
        formatedSpecialPrice = data["formatedFinalPrice"].stringValue
        qty = "1";
        hasOption = data["hasOptions"].intValue
        wishlistItemId = data["wishlistItemId"].stringValue
        
        isFreeshipping = data["isFreeshipping"].stringValue
        shippingPrice = data["shippingPrice"].stringValue
    }
}
