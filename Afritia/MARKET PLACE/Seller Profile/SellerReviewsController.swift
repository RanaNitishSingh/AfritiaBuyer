...
class SellerReviewsController: UIViewController ,UITableViewDataSource,UITableViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = "sellerreviews".localized
    ...
    func callingHttppApi(){
        ...
        APIServiceManager.shared.callingHttpRequest(params:requstParams, apiname:"mobikulmphttp/marketplace/SellerReviews", currentView: self){success,responseObject in
            if success == 1{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let sellBy = "by"+" "+self.sellerReviewViewModel.sellerReviewCollectionModel[indexPath.section].name
        let sellOn = "on"+" "+self.sellerReviewViewModel.sellerReviewCollectionModel[indexPath.row].date
