...
class SellerContactTableViewCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        image1.backgroundColor = UIColor.button
        image2.backgroundColor = UIColor.button
        image3.backgroundColor = UIColor.button
        image4.backgroundColor = UIColor.button
        image5.backgroundColor = UIColor.button
        image6.backgroundColor = UIColor.button
        ...
        aboutStoreLabel.text = "aboutstore".localized
        reviewsLabel.text = "reviews".localized
        locationLabel.text = "location".localized
        contactLabel.text = "contactus".localized
        shippingPolicyLabel.text = "shippingpolicy".localized
        policyLabel.text = "returnpolicy".localized
