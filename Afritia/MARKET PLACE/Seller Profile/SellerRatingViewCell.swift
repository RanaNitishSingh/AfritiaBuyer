...
class SellerRatingViewCell: UITableViewCell {
    ...
    override func setSelected(_ selected: Bool, animated: Bool) {
        ...
        priceRating1Value.progressTintColor = UIColor.appGreen
        priceRating2Value.progressTintColor = UIColor.appGreen
        ...
        valueRating1LabelValue.progressTintColor = UIColor.appGreen
        valueRating2LabelValue.progressTintColor = UIColor.appGreen
        ...
        qualityRating1LabelValue.progressTintColor = UIColor.appGreen
        qualityRating2LabelValue.progressTintColor = UIColor.appGreen
        ...
        priceRatingImage.backgroundColor = UIColor.appGreen
        valueRatingImage.backgroundColor = UIColor.appGreen
        qualityRatingImage.backgroundColor = UIColor.appGreen
        averageStarImage.backgroundColor = UIColor.appGreen
        
        view1.layer.cornerRadius = 2.0
        view1.layer.borderWidth = 0.5
        view1.layer.borderColor = UIColor.button.cgColor
        
        view2.layer.cornerRadius = 2.0
        view2.layer.borderWidth = 0.5
        view2.layer.borderColor = UIColor.button.cgColor
        view3.layer.cornerRadius = 2.0
        view3.layer.borderWidth = 0.5
        view3.layer.borderColor = UIColor.button.cgColor
